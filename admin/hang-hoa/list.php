                ...
                <div class="card">
                    ...
                    <div class="container-fluid">
                        <div class="row d-flex align-items-center">
                            ...
                            <p class="col-lg-1"><?php echo $hanghoa->ma_hh ?></p>
                            <p class="col-lg-2"><?php echo $hanghoa->ten_hh ?></p>
                            <img class="col-lg-1" src="<?php echo $hanghoa->hinh_anh ?>" alt="">
                            <p class="col-lg-2 multiline-truncate"><?php echo $hanghoa->mo_ta ?></p>
                            <p class="col-lg-1"><?php echo $hanghoa->don_gia ?> VND</p>
                            <p class="col-lg-1"><?php echo $hanghoa->giam_gia ?> VND</p>
                            <p class="col-lg-1"><?php echo $hanghoa->ngay_nhap ?></p>
                            <div class="col-lg-1">
                                <form action="">
